...
class ActivityLoggerController extends Controller
{
     ...
     */
    public function showAccessLog(Request $request) : JsonResponse
    {
    ...
    public function clearActivityLog(Request $request)
    {
        ...
        $message = trans('LaravelLogger::laravel-logger.messages.logClearedSuccessfuly');
    ...
    public function destroyActivityLog(Request $request)
    {
        ...
        $message = trans('LaravelLogger::laravel-logger.messages.logDestroyedSuccessfuly');
        return response()->json($message, Response::HTTP_OK);
    }
    ...
    public function restoreClearedActivityLog(Request $request)
    {
        ...
        $message = trans('LaravelLogger::laravel-logger.messages.logRestoredSuccessfuly');
        return response()->json($message, Response::HTTP_OK);
    }
