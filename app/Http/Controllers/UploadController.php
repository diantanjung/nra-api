...
class UploadController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        // Storage::disk('do')->put($file_name, file_get_contents($request->file));

        // $cdn_url = config('filesystems.disks.do.cdn_endpoint') . "/" . $file_name;
        // return responseSuccess(compact('cdn_url'));

        return responseSuccess("https://ui-avatars.com/api/?name=WR&background=random");
    }
}
